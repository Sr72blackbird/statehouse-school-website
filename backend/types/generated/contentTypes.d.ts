...
export interface ApiAboutTheSchoolAboutTheSchool
...
export interface ApiAcademicDepartmentAcademicDepartment
  extends Struct.CollectionTypeSchema {
  collectionName: 'academic_departments';
  info: {
    displayName: 'Academic Department';
    pluralName: 'academic-departments';
    singularName: 'academic-department';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::academic-department.academic-department'
    > &
      Schema.Attribute.Private;
...
export interface ApiAdmissionRequirementAdmissionRequirement
  extends Struct.CollectionTypeSchema {
  collectionName: 'admission_requirements';
  info: {
    displayName: 'Admission Requirements';
    pluralName: 'admission-requirements';
    singularName: 'admission-requirement';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admission-requirement.admission-requirement'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    Category: Schema.Attribute.Enumeration<['News', 'Notice', 'Event']>;
...
export interface ApiCbcPathwayCbcPathway extends Struct.CollectionTypeSchema {
  collectionName: 'cbc_pathways';
  info: {
    displayName: 'CBC Pathway';
    pluralName: 'cbc-pathways';
    singularName: 'cbc-pathway';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiLearningAreasSubjectLearningAreasSubject
  extends Struct.CollectionTypeSchema {
  collectionName: 'learning_areas_subjects';
  info: {
    displayName: 'Learning Areas/Subject';
    pluralName: 'learning-areas-subjects';
    singularName: 'learning-areas-subject';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::learning-areas-subject.learning-areas-subject'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer;
    pathway: Schema.Attribute.Relation<
      'oneToOne',
      'api::cbc-pathway.cbc-pathway'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-the-school.about-the-school': ApiAboutTheSchoolAboutTheSchool;
      'api::academic-department.academic-department': ApiAcademicDepartmentAcademicDepartment;
      'api::admission-requirement.admission-requirement': ApiAdmissionRequirementAdmissionRequirement;
